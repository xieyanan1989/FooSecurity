...
public class JLActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chuanSelect = new ChuanSelectView(JLActivity.this, jc_chuan_select_plays, chuanCheck);
                ...
                if ((chuan + 1) > selectMatchs.size()) {
                    ...
                    if (chuan == 0) {
                        ...
                        if (!single) {
                            ...
                            Toast.makeText(JLActivity.this, "未选择单关赛事", Toast.LENGTH_SHORT).show();
                        }
                    }
                    //当赛事大于串关的时候，串关选择规则
