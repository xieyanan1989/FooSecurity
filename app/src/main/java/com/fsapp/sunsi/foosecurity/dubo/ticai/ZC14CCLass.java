...
public class ZC14CCLass extends JCAbstractClass {
	...
	public ZC14CCLass(Context context, LayoutInflater inflater,String lotteryid) {
	...
	public void showItems(final JZMatchBean bean, LinearLayout parent_layout) {
		...
		View convertView = inflater.inflate(R.layout.zc_14chang_item, null);
...
//					Date dt1 = df.parse("2015-10-18 17:00:00");
		        	if((System.currentTimeMillis()+1200000) > dt1.getTime()){
						...
						SetReturnOnclick(LotteryId.CTZC14,LotteryId.PLAY_ID_01,bean);
		        	}
				} catch (Exception e) {
					e.printStackTrace();
				}
